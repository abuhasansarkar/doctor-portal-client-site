    ...
    <div className="lg:w-[1400px] mx-auto py-16">
      <div className="w-1/3 mx-auto border p-10 rounded-lg shadow-2xl">
        <form>
          ...
          <label className="label">
            <Link className="label-text">ForGot Your Password?</Link>
          </label>
          <button className="btn btn-accent w-full text-white mt-2">Login</button>
        </form>
          <h4>New to Doctors Portal? <span className="text-primary"><Link to='/singup'>Create New Account</Link></span></h4>
